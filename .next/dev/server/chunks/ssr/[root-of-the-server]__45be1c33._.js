...
// attach token from localStorage when present (client side)
...
;
;
const { Header, Content, Footer } = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$antd$2f$es$2f$layout$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__default__as__Layout$3e$__["Layout"];
function JoinPage() {
    const [step, setStep] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(1); // 1 = phone, 2 = otp
    ...
    const sendOtp = ()=>{
        ...
        setTimeout(()=>{
            setLoading(false);
            setStep(2);
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$antd$2f$es$2f$message$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__default__as__message$3e$__["message"].success(`OTP sent to +91 ${phone}`);
        }, 800);
    };
    const verifyOtp = ()=>{
        ...
        setTimeout(()=>{
            setLoading(false);
            if (otp === "123456") {
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$antd$2f$es$2f$message$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__default__as__message$3e$__["message"].success("Verified! Welcome to SainVandeBharat.");
            // redirect or set auth state here
            } else {
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$antd$2f$es$2f$message$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__default__as__message$3e$__["message"].error("Invalid OTP. Try 123456 (test)");
            }
        }, 800);
    };
...
//# sourceMappingURL=%5Broot-of-the-server%5D__45be1c33._.js.map