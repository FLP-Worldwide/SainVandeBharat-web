...
const userApi = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].create({
...
"[project]/src/app/join/page.jsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function JoinPage() {
    ...
    // flow state
    const [step, setStep] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(1); // 1 phone, 2 otp, 3 extra-info
    ...
    const [missingFields, setMissingFields] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(null);
    ...
    const sendOtp = async ()=>{
        if (!/^\d{10}$/.test(phone)) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$antd$2f$es$2f$message$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__default__as__message$3e$__["message"].error("Please enter a valid 10-digit phone number");
        }
        setLoading(true);
        try {
            const res = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$api$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["authApi"].post("/auth/login", {
                phone: phone
            });
            if (res?.data?.success) {
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$antd$2f$es$2f$message$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__default__as__message$3e$__["message"].success(res.data.message || "OTP sent!");
                if (res.data.otp) console.debug("dev OTP:", res.data.otp);
                setStep(2);
                setOtp(res.data.otp || "");
            } else {
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$antd$2f$es$2f$message$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__default__as__message$3e$__["message"].error(res?.data?.message || "Error sending OTP");
            }
        } catch (err) {
            const errMsg = err?.response?.data?.message || err.message || "Auth service error";
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$antd$2f$es$2f$message$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__default__as__message$3e$__["message"].error(errMsg);
        } finally{
            setLoading(false);
        }
    };
    ...
    const verifyOtp = async ()=>{
        if (!/^\d{4,6}$/.test(otp)) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$antd$2f$es$2f$message$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__default__as__message$3e$__["message"].error("Enter a valid OTP");
        setLoading(true);
        try {
            const res = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$api$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["authApi"].post("/auth/verify", {
                phone: phone,
                otp: otp
            });
            ...
            if (res?.data?.success && res?.data?.token) {
                ...
                if ("TURBOPACK compile-time falsy", 0) //TURBOPACK unreachable
                ;
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$antd$2f$es$2f$message$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__default__as__message$3e$__["message"].success("Logged in successfully");
                router.push("/");
                return;
            }
            ...
            if (res?.data?.code === "additional_info_required") {
                ...
                setStep(3);
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$antd$2f$es$2f$message$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__default__as__message$3e$__["message"].info("Please complete your profile to continue");
                return;
            }
    ...
    const submitAdditionalInfo = async (values)=>{
        ...
        if (!userId) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$antd$2f$es$2f$message$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__default__as__message$3e$__["message"].error("Missing userId. Please restart the flow.");
        setLoading(true);
        try {
            const payload = {
                userId,
            ...
            const res = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$api$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["authApi"].post("/auth/complete", payload);
            if (res?.data?.success && res?.data?.token) {
                const token = res.data.token;
                const user = res.data.user || null;
                ...
                if ("TURBOPACK compile-time falsy", 0) //TURBOPACK unreachable
                ;
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$antd$2f$es$2f$message$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__default__as__message$3e$__["message"].success("Profile completed and logged in");
...
//# sourceMappingURL=%5Broot-of-the-server%5D__06dd35da._.js.map